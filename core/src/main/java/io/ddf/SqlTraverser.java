...
/**
 * General sql parser
 * It should be extended for specific parsing/manipulation purposes
 */
public class SqlTraverser
  ...
  protected void visit(SortByElement sortByElement) throws Exception {
    sortByElement.getExpression().accept(this);
  }

  protected void visit(DistributeByElement distributeByElement) throws Exception {
