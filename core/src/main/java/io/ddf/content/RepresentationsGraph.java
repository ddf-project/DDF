...
public class RepresentationsGraph {
  ...
  public ConvertFunction addEdge(Representation startVertex, Representation endVertex, ConvertFunction convertFunction) {
  ...
  public GraphPath<Representation, ConvertFunction> getShortestPath(Representation startVertex, Representation endVertex) {
    try {
