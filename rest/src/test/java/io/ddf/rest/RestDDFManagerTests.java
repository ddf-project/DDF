...
public class RestDDFManagerTests {
    ...
    public void testGetData() throws DDFException {
        RestDDF ddf = restDDFManager.newDDF("http://api.openweathermap.org/data/2.5/weather?q=London,uk&appid=2de143494c0b295cca9337e1e96b00e0");
        restDDFManager.getData(ddf);
    }
