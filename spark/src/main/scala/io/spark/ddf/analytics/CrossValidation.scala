...
private[spark] class SeededPartition(val prev: Partition, val seed: Int) extends Partition with Serializable {
  override val index: Int = prev.index
}

private[spark] class RandomSplitRDD[T: ClassManifest](
                                                       prev: RDD[T],
                                                       seed: Long,
                                                       lower: Double,
                                                       upper: Double,
