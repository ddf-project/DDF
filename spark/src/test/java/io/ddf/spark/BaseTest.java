...
public class BaseTest {
    ...
    public void createTableMovie() throws DDFException {
        manager.sql2txt("drop table if exists movie");

        manager.sql2txt("create table movie (" +
        ...
        manager.sql2txt("load data local inpath '../resources/test/movies.csv' into table movie");
    }
